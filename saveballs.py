...
#gbs.set_volume(.9)
my_font = pg.font.SysFont("comicsansms", 24)
...
def start_game():
    while True:
        ...
        window.blit(sicon,(200,336))
        window.blit(qicon,(472,336))
        start_text=startfont.render('Save the balls',True,[0,10,190])
        window.blit(start_text,(window.get_width() / 2 - start_text.get_rect().width / 2, 170))
        byme=byfont.render('By: Shivam Maurya',True,[0,0,0])
        window.blit(byme,(630,560))
        button_action(200,335,328,460,"play")
        button_action(470,335,598,460,"quit")
